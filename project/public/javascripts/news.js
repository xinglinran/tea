$(function(){ 
	...
	var fenye1 = $('#fenye1')[0];
	var fenye4 = $('#fenye4')[0];
	var zy = Number(fenye1.innerText);
	console.log(zy);
	...
	$('#fenye5')[0].onclick = function(){
		y++;
		fenye4.innerText = y+1;
		if(y>=zy){
			y=zy-1;
		fenye4.innerText = zy;
		}
	...
	$('#fenye2')[0].onclick = function(){
		y=0;
		fen(y);
		console.log(111);
		fenye4.innerText = 1;
	}
	$('#fenye6')[0].onclick = function(){
		y=zy-1;
		fen(y);
		console.log(111);
		fenye4.innerText = y+1;
